...
- On considère 2 modèles: l'un modélise snapshot2 en fonction d'autres variables et l'autre modélise l'écart snapshot2-$\alpha$snapshot1 en variant $\alpha$ de 0.1 à 2.
